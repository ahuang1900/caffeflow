from caffeflow.tensorflow import Network

class NiN(Network):
    def setup(self):
        (self.feed('data')
             .conv(11, 11, 96, 4, 4, operator_padding='VALID', name='conv1')
